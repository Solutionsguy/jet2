        ...
        <div class="header-right d-flex align-items-center">
            <a href="/deposit">
                <button class="deposite-btn rounded-pill d-flex align-items-center me-2">
                    ...
                    <!-- <span>$</span> -->
                    <span class="me-2" id="header_wallet_balance">₹<?php echo e(wallet(user('id'))); ?></span>
                    DEPOSIT
                </button>
            </a>
            <div class="btn-group">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-dark profile-dropdown p-0">
                        <li class="profile-head d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                <img src="<?php echo e(user('image')); ?>" class="avtar-ico" id="avatar_img">
                                <div>
                                    <div class="profile-name mb-1"><?php echo e(user('email')); ?> </div>
                                    <div class="profile-name" id="username"><?php echo e(user('id')); ?></div>
                                </div>
    ...
    <div class="header-bottom ">
        ...
        <div class="header-right d-flex align-items-center">
            ...
            <div class="wallet-balance h-26">
                <span id="wallet_balance"><?php echo e(wallet(user('id'))); ?></span>
            </div>
        </div>
    </div>
</header>
<!--====== Header End ======--><?php /**PATH C:\xampp\htdocs\jet\jet\laravel\resources\views/include/game-header.blade.php ENDPATH**/ ?>